...
<!-- Mirrored from clabs.co/projects/metro/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2017 02:58:30 GMT -->
<head>
		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="login-box">
					...
					<h2><?php $err = $this->session->userdata('error'); 
					if( $err ){
						echo $err;
						$this->session->unset_userdata('error');
					}
					?></h2>
					<form class="form-horizontal" action="<?php echo base_url(); ?>Admin_Controller/login_check" method="post">
						<fieldset>
							
							<div class="input-prepend" title="Username">
								<span class="add-on"><i class="halflings-icon user"></i></span>
								<input class="input-large span10" name="admin_er_username" id="username" type="text" placeholder="type username"/>
							</div>
							<div class="clearfix"></div>

							<div class="input-prepend" title="Password">
								<span class="add-on"><i class="halflings-icon lock"></i></span>
								<input class="input-large span10" name="admin_er_password" id="password" type="password" placeholder="type password"/>
							</div>
							<div class="clearfix"></div>
