...
<!-- Mirrored from clabs.co/projects/metro/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Jul 2017 02:57:47 GMT -->
<head>
					...
					<ul class="nav pull-right">
						...
						<li class="dropdown hidden-phone">
							...
							<ul class="dropdown-menu messages">
                            	...
                            	<li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url(); ?>assets/backEnd/img/avatar.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Łukasz Holeczek
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url(); ?>assets/backEnd/img/avatar2.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Megan Abott
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url(); ?>assets/backEnd/img/avatar3.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Kate Ross
										     </span>
								...
								<li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url(); ?>assets/backEnd/img/avatar4.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Julie Blank
										     </span>
                                ...
                                <li>
                                    <a href="#">
										<span class="avatar"><img src="<?php echo base_url(); ?>assets/backEnd/img/avatar5.jpg" alt="Avatar"></span>
										<span class="header">
											<span class="from">
										    	Jane Sanders
										     </span>
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="<?php echo base_url(); ?>Superadmin/logout"><i class="halflings-icon off"></i> Logout</a></li>
							</ul>
						</li>
						<!-- end: User Dropdown -->
					</ul>
