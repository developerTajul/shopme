...
<?php foreach ($contents as $value) : ?>
					<tr>
						...
						<td class="product_image_col" data-title="Product Image">
							...
							<a href="#"><img src="<?php echo base_url().$value['options']['image']; ?>" alt=""></a>
						...
						<td data-title="Product Name">
							...
							<a href="#" class="product_title"><?php echo $value['name']; ?></a>
...
<!-- <button type="submit" name="update_cart"  class="theme_button" data-direction="plus">&#43;</button> -->
			...
			<input type="submit" name="update_cart" value="Update Now">	
						...
						<td data-title="Action">
							...
							<a href="<?php echo base_url(); ?>Cart/delete_from_cart/<?php echo $value['rowid']; ?>" class="button_dark_grey icon_btn remove_product"><i class="icon-cancel-2"></i></a>
