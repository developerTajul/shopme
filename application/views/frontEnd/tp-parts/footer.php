<footer id="footer">
										...
										<li>
											...
											<article class="entry">
												...
												<a href="#" class="entry_thumb">
													...
													<img src="<?php echo base_url(); ?>assets/frontEnd/images/latest_news_thumb_1.jpg" alt="">
										...
										<li>
											...
											<article class="entry">
												...
												<a href="#" class="entry_thumb">
													...
													<img src="<?php echo base_url(); ?>assets/frontEnd/images/latest_news_thumb_2.jpg" alt="">
										...
										<li>
											...
											<article class="entry">
												...
												<a href="#" class="entry_thumb">
													...
													<img src="<?php echo base_url(); ?>assets/frontEnd/images/latest_news_thumb_3.jpg" alt="">
						...
						<div class="row">
							...
							<div class="col-xs-12">
								...
								<ul class="payments">
									...
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_1.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_2.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_3.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_4.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_5.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_6.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_7.png" alt=""></li>
									<li><img src="<?php echo base_url(); ?>assets/frontEnd/images/payment_8.png" alt=""></li>
		...
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/queryloader2.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/rs-plugin/js/jquery.themepunch.tools.min.js"></script>
		...
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/royalslider/jquery.easing-1.3.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/jquery.countdown.plugin.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/jquery.countdown.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/arcticmodal/jquery.arcticmodal.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/twitter/jquery.tweet.min.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/colorpicker/colorpicker.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/retina.min.js"></script>
		<script type="text/javascript" src="http://s7.addthis.com/js/300/addthis_widget.js"></script>

		<!-- Theme files
		============================================ -->
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/theme.plugins.js"></script>
		<script src="<?php echo base_url(); ?>assets/frontEnd/js/theme.core.js"></script>
